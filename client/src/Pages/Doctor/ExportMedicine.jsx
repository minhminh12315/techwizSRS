...
const ExportMedicine = () => {
  ...
  const handleSubmitExport = () => {
    ...
    axios
      .post("http://localhost:8000/api/export-medicine", {
  ...
  useEffect(() => {
    console.log("Exported medicines:", exportedMedicine);
  }, [exportedMedicine]);
      ...
      <div className="row">
                  ...
                  <tr key={index}>
                    ...
                    <td>
                      <div className="quantity_container">
                        ...
                        {exportedMedicineQuantity[index] || 0}{" "}
                        {/* Hiển thị số lượng hiện tại hoặc 0 nếu chưa có */}
                        <button
                          className="btn_plus"
                          onClick={() => {
                            const newQuantity = [...exportedMedicineQuantity];
                    ...
                    <td>
                      <div className="d-flex justify-content-center">
                        <button
                          onClick={() => handleExport(medicine, index)}
        ...
        <div className="col-5 ps-4">
          ...
          <div className="d-flex justify-content-end pe-3">
            <button onClick={() => {}} className="btn_primary_custom">
              Export
            </button>
          </div>
        </div>
